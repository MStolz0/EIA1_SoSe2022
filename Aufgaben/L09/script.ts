function playSample(beats):void {
...
//Loop
   ...
   var loop:HTMLAudioElement []= [sound[01],sound[02],sound[03],sound[04],sound[05],sound[06],sound[07],sound[08],sound[09],sound[10],sound[11],sound[12],]
