...
function Key2(){
    var sound:HTMLAudioElement = new Audio('./Sounds/D.mp3');
    sound.play();
    sound.volume = 0.3;
    sound.currentTime = 0
}
...
function black2(){
    var sound:HTMLAudioElement = new Audio('./Sounds/D4.mp3');
    sound.play();
    sound.volume = 0.3;
    sound.currentTime = 0
}
...
function Key3(){
    var sound:HTMLAudioElement = new Audio('./Sounds/E.mp3');
    sound.play();
    sound.volume = 0.3;
    sound.currentTime = 0
}
...
function black3(){
    var sound:HTMLAudioElement = new Audio('./Sounds/F4.mp3');
    sound.play();
    sound.volume = 0.3;
    sound.currentTime = 0
}
...
function black4(){
    var sound:HTMLAudioElement = new Audio('./Sounds/G4.mp3');
    sound.play();
    sound.volume = 0.3;
    sound.currentTime = 0
}
...
function black5(){
    var sound:HTMLAudioElement = new Audio('./Sounds/A4.mp3');
    sound.play();
    sound.volume = 0.3;
    sound.currentTime = 0
}
...
function Key7(){
    var sound:HTMLAudioElement = new Audio('./Sounds/B.mp3');
    sound.play();
    sound.volume = 0.3;
    sound.currentTime = 0
}
